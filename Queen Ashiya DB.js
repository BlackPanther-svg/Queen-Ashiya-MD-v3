...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (kuismath.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await reply(`🎮 Math Quiz 🎮\n\nCorrect Answer 🎉\n\nWant To Play Again? Send ${prefix}⚒⃟►math mode`)
...
if (!isCreator) return replay(mess.owner)
if (!args[0]) return replay(`Select add or del(add to ban, del to unban), For Example: Reply *${prefix}⚒⃟►ban add* to the user u want to ban`)
if (args[1]) {
...
Type *surrender* to surrender and admit defeat`
            ...
            reply('Waiting For Partner' + (text ? ` Type The Command Below ${prefix}⚒⃟►${command} ${text}` : ''))
...
if (isBanChat) return reply(mess.banChat)
	    ...
	    if (m.mentionedJid[0] === m.sender) return reply(`Can't Play With Myself !`)
            if (!m.mentionedJid[0]) return reply(`_Who Do You Want To Challenge?_\nTag The Person..\n\nExample : ${prefix}⚒⃟►suit @${owner[1]}`, m.chat, { mentions: [owner[1] + '@s.whatsapp.net'] })
...
if (isBanChat) return reply(mess.banChat)
                ...
                if (!text) return replay(`Mode: ${Object.keys(modes).join(' | ')}\nFor Examples: ${prefix}⚒⃟►math medium`)
...
if (isBanChat) return reply(mess.banChat)
            if (!m.isGroup) return replay(`${mess.group}`)
            if (m.chat in vote) replay(`_There Are Still Votes In This Chat!_\n\n*${prefix}⚒⃟►delvote* - To Delete Vote Session`)
            if (!text) return replay(`Enter Reason For Vote, Example: *${prefix + command} Handsome Owner*`)
            reply(`Voting Starts!\n\n*${prefix}⚒⃟►upvote* - For Upvote\n*${prefix}⚒⃟►devote* - For Devote\n*${prefix}⚒⃟►checkvote* - To Check The Vote\n*${prefix}⚒⃟►delvote* - To Delete Vote Session`)
            vote[m.chat] = [q, [], []]
            await sleep(1000)
...
*${prefix}⚒⃟►delvote* - To Delete Vote Session`
let buttonsVote = [
  {buttonId: `${prefix}⚒⃟►upvote`, buttonText: {displayText: 'Upvote'}, type: 1},
  {buttonId: `${prefix}⚒⃟►devote`, buttonText: {displayText: 'Devote'}, type: 1}
]
...
if (isBanChat) return reply(mess.banChat)
if (!isCreator) return replay(mess.owner)
                if (!text) return reply(`Use ${prefix}⚒⃟►bcloc text\n\nExample : ${prefix + command} attention everybody`)
                let anu = await store.chats.all().map(v => v.id)
                let [melo, melo2] = text.split`|`
                reply(`*Send Broadcast To* ${anu.length} Chat\nTime ${anu.length * 1.5} sec`)
	     	for (let yoi of anu) {
	     	await sleep(1500)
		    var button = [{ buttonId: `${prefix}⚒⃟►ho`, buttonText: { displayText: `${melo2}` }, type: 1 }]              
...
if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
           if (!text) reply(`Use ${prefix}⚒⃟►attp hello\n*Example : ${prefix + command} ${ownername}*` )
...
case 'fbdl': case 'fb': case 'facebook': case 'fbmp4': {     	    
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
             if (!text) return reply(`Where is the link bro?\nExample: ${prefix}⚒⃟►facebook https://www.facebook.com/groups/599913174599515/permalink/705467384044093/`)
...
break
	...
	reply(mess.wait)
            ...
            if (!args[0]) reply(`Use ${prefix}⚒⃟►gitclone repo link\nExample: https://github.com/DGXeon/CheemsBot-MD4`)
...
case 'lyrics': {
		            	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
	    if (!text) return reply(`Use example ${prefix}⚒⃟►lyrics Despacito`)
	reply(mess.wait)
...
case 'searchgc': {
   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (args.length < 1) return replay(`Example :\n${prefix}⚒⃟►searchgc Classy Editor`)
nae = args.join(" ")
...
case 'shortstoryx':{
	   if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
if (!q) return reply(`*List*\n${prefix}⚒⃟►shortstory Anak\n${prefix}⚒⃟►shortstory Bahasa Daerah\n${prefix}⚒⃟►shortstory Bahasa Inggris\n${prefix}⚒⃟►shortstory Bahasa Jawa\n${prefix}⚒⃟►shortstory Bahasa Sunda\n${prefix}⚒⃟►shortstory Budaya\n${prefix}⚒⃟►shortstory Cinta\n${prefix}⚒⃟►shortstory Cinta Islami\n${prefix}⚒⃟►shortstory Cinta Pertama\n${prefix}⚒⃟►shortstory Cinta Romantis\n${prefix}⚒⃟►shortstory Cinta Sedih\n${prefix}⚒⃟►shortstory Cinta Segitiga\n${prefix}⚒⃟►shortstory Cinta Sejati\n${prefix}⚒⃟►shortstory Galau\n${prefix}⚒⃟►shortstory Gokil\n${prefix}⚒⃟►shortstory Inspiratif\n${prefix}⚒⃟►shortstory Jepang\n${prefix}⚒⃟►shortstory Kehidupan\n${prefix}⚒⃟►shortstory Keluarga\n${prefix}⚒⃟►shortstory Kisah Nyata\n${prefix}⚒⃟►shortstory Korea\n${prefix}⚒⃟►shortstory Kristen\n${prefix}⚒⃟►shortstory Liburan\n${prefix}⚒⃟►shortstory Lingkungan\n${prefix}⚒⃟►shortstory Lucu\n${prefix}⚒⃟►shortstory Malaysia\n${prefix}⚒⃟►shortstory Mengharukan\n${prefix}⚒⃟►shortstory Misteri\n${prefix}⚒⃟►shortstory Motivasi\n${prefix}⚒⃟►shortstory Nasihat\n${prefix}⚒⃟►shortstory Nasionalisme\n${prefix}⚒⃟►shortstory Olahraga\n${prefix}⚒⃟►shortstory Patah Hati\n${prefix}⚒⃟►shortstory Penantian\n${prefix}⚒⃟►shortstory Pendidikan\n${prefix}⚒⃟►shortstory Pengalaman Pribadi\n${prefix}⚒⃟►shortstory Pengorbanan\n${prefix}⚒⃟►shortstory Penyesalan\n${prefix}⚒⃟►shortstory Perjuangan\n${prefix}⚒⃟►shortstory Perpisahan\n${prefix}⚒⃟►shortstory Persahabatan\n${prefix}⚒⃟►shortstory Petualangan\n${prefix}⚒⃟►shortstory Ramadhan\n${prefix}⚒⃟►shortstory Remaja\n${prefix}⚒⃟►shortstory Renungan\n${prefix}⚒⃟►shortstory Rindu\n${prefix}⚒⃟►shortstory Rohani\n${prefix}⚒⃟►shortstory Romantis\n${prefix}⚒⃟►shortstory Sastra\n${prefix}⚒⃟►shortstory Sedih\n${prefix}⚒⃟►shortstory Sejarah\n${prefix}⚒⃟►shortstory Slice Of Life\n${prefix}⚒⃟►shortstory Terjemahan\n${prefix}⚒⃟►shortstory Thriller`)
...
Access With ${prefix}⚒⃟►getmsg ${text}

View List Of Messages With ${prefix}⚒⃟►listmsg`)
            }
            break
            case 'getmsg': {
            	if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
                if (!text) return reply(`Example : ${prefix + command} file name\n\nView Message List With ${prefix}⚒⃟►listmsg`)
                let msgs = global.db.data.database
								...
								"rows": [
									{
										...
										"rowId": `${prefix}⚒⃟►allmenu`
									},
									{
										"title": "Owner Menu 💠",
										"description": "Displays The List Of Owner Features",
										"rowId": `${prefix}⚒⃟►ownermenu`
										},
									{
										"title": "Group Menu ✨",
										"description": "Displays The List Of Main Features",
										"rowId": `${prefix}⚒⃟►groupmenu`
										},
										{
										"title": "Maker Menu 🌈",
										"description": "Displays The List Of Logo Making Features",
										"rowId": `${prefix}⚒⃟►indomenu`
									},
									{
										"title": "Sound Menu 🎵",
										"description": "Displays The List Of Sound Features",
										"rowId": `${prefix}⚒⃟►soundmenu`
									},
									{
										"title": "Download Menu ↘️",
										"description": "Displays The List Of Download Features",
										"rowId": `${prefix}⚒⃟►downloadmenu`
									},
									{
										"title": "Sticker Menu 🃏",
									...
									},
									{
										...
										"rowId": `${prefix}⚒⃟►searchmenu`
									},
									{
										"title": "Tool Menu ⚙️",
										"description": "Displays The List Of Tool Features",
										"rowId": `${prefix}⚒⃟►toolmenu`
									},
									{
										"title": "Random Image Menu 🌆",
										"description": "Displays The List Of Random Image Features",
										"rowId": `${prefix}⚒⃟►randomimagemenu`
									},
									{
										"title": "Image Effect Menu 🖼️",
										"description": "Displays The List Of Image Effect Features",
										"rowId": `${prefix}⚒⃟►imageeffectmenu`
									},
										{
											"title": "Anime Menu 😘",
										"description": "Displays The List Of Random Anime Features",
										"rowId": `${prefix}⚒⃟►animemenu`
										},
										{
											"title": "Emote Menu 😀",
										"description": "Displays The List Of Emote Features",
										"rowId": `${prefix}⚒⃟►emotemenu`
										},
										{
										"title": "Anime Sticker Menu ☺️",
										"description": "Displays The List Of Anime Sticker Features",
										"rowId": `${prefix}⚒⃟►animestickermenu`
									     },
									{
										"title": "Nsfw Menu 🤓",
										"description": "Displays The List Of Nsfe Features",
										"rowId": `${prefix}⚒⃟►nsfwmenu`
									     },
										{
											"title": "Fun Menu 🕺",
										"description": "Displays The List Of Fun Features",
										"rowId": `${prefix}⚒⃟►funmenu`
										},
										{
										"title": "Game Menu 🎮",
										...
										"rowId": `${prefix}⚒⃟►convertmenu`
										},
										{
											"title": "Database Menu ♻️",
										"description": "Displays The List Of Database Features",
										"rowId": `${prefix}⚒⃟►databasemenu`
										},
										{
										"title": "Indo Menu  🦜",
										...
										"rowId": `${prefix}⚒⃟►indohoroscopemenu`
										}
								]
							},
							{
...
▷ ${prefix}⚒⃟►public
▷ ${prefix}⚒⃟►antitag
▷ ${prefix}⚒⃟►rentbot [add/del]
▷ ${prefix}⚒⃟►rentlist
▷ ${prefix}⚒⃟►ban [add/del]
▷ ${prefix}⚒⃟►banchat [on/off]
▷ ${prefix}⚒⃟►join [link]
▷ ${prefix}⚒⃟►leavegc
▷ ${prefix}⚒⃟►setbio
▷ ${prefix}⚒⃟►bcgroup [text]
▷ ${prefix}⚒⃟►bcall [text]
▷ ${prefix}⚒⃟►bcimage [image]
▷ ${prefix}⚒⃟►bcvideo [video]
▷ ${prefix}⚒⃟►bcaudio [audio]
▷ ${prefix}⚒⃟►bcloc [text]
▷ ${prefix}⚒⃟►setppbot [image]
▷ ${prefix}⚒⃟►setexif
▷ ${prefix}⚒⃟►block [tag/number]
▷ ${prefix}⚒⃟►unblock [tag/number]
▷ ${prefix}⚒⃟►coowner [add/del]
▷▂▂▂▂▂▂▂◑「 GROUP 」	        
▷${prefix}⚒⃟►grousetting
▷${prefix}⚒⃟►grouplink
▷${prefix}⚒⃟►ephemeral [option]
▷${prefix}⚒⃟►setgcpp [image]
▷${prefix}⚒⃟►setname [text]
▷${prefix}⚒⃟►setdesc [text]
▷${prefix}⚒⃟►group 
▷${prefix}⚒⃟►resetgrouplink
▷${prefix}⚒⃟►editinfo [option]
▷${prefix}⚒⃟►add [user]
▷${prefix}⚒⃟►kick [reply/tag]
▷${prefix}⚒⃟►hidetag [text]
▷${prefix}⚒⃟►tagall [text]
▷${prefix}⚒⃟►antilinkgc [on/off]
▷${prefix}⚒⃟►antilinktg [on/off]
▷${prefix}⚒⃟►antilinktt [on/off]
▷${prefix}⚒⃟►antilinkytch [on/off]
▷${prefix}⚒⃟►antilinkytvid [on/off]
▷${prefix}⚒⃟►antilinkig [on/off]
▷${prefix}⚒⃟►antilinkfb [on/off]
▷${prefix}⚒⃟►antilinktwit [on/off]
▷${prefix}⚒⃟►antilinkall [on/off]
▷${prefix}⚒⃟►antivirus [on/off]
▷${prefix}⚒⃟►antitoxic [on/off]
▷${prefix}⚒⃟►antiwame [on/off]
▷${prefix}⚒⃟►autoreply [on/off]
▷${prefix}⚒⃟►nsfw [on/off]
▷${prefix}⚒⃟►promote [reply/tag]
▷${prefix}⚒⃟►demote [reply/tag]
▷${prefix}⚒⃟►react [reply emoji]
▷${prefix}⚒⃟►vote
▷${prefix}⚒⃟►devote
▷${prefix}⚒⃟►upvote
▷${prefix}⚒⃟►checkvote
...
▷${prefix}⚒⃟►snow
▷${prefix}⚒⃟►harrypot
▷${prefix}⚒⃟►harrypotter
▷${prefix}⚒⃟►brokenglass
▷${prefix}⚒⃟►waterpipe
▷${prefix}⚒⃟►spooky
▷${prefix}⚒⃟►circuit
▷${prefix}⚒⃟►metallic
▷${prefix}⚒⃟►demon
▷${prefix}⚒⃟►sparklechristmas
▷${prefix}⚒⃟►christmas
▷${prefix}⚒⃟►3dchristmas
▷${prefix}⚒⃟►3dbox
▷${prefix}⚒⃟►waterdrop
▷${prefix}⚒⃟►lion2
▷${prefix}⚒⃟►papercut
▷${prefix}⚒⃟►transformer
▷${prefix}⚒⃟►neondevil
▷${prefix}⚒⃟►3davengers
▷${prefix}⚒⃟►3dstone
▷${prefix}⚒⃟►3dstone2
...
▷ ${prefix}⚒⃟►foggy
▷ ${prefix}⚒⃟►writing
▷ ${prefix}⚒⃟►halloweenfire
▷ ${prefix}⚒⃟►halloween
▷ ${prefix}⚒⃟►watercolor
▷ ${prefix}⚒⃟►classic
▷▂▂▂▂▂◑「 DOWNLOAD 」	
▷${prefix}⚒⃟►instagram [url]
▷${prefix}⚒⃟►igtv [url]
▷${prefix}⚒⃟►igstory [username]
▷${prefix}⚒⃟►facebook [url]
▷${prefix}⚒⃟►fbmp3 [url]
▷${prefix}⚒⃟►twitter [url]
▷${prefix}⚒⃟►twittermp3 [url]
▷${prefix}⚒⃟►tiktok [url]
▷${prefix}⚒⃟►tiktokaudio[url]
▷${prefix}⚒⃟►tiktoknowm [url]
▷${prefix}⚒⃟►mediafire [url]
▷${prefix}⚒⃟►ytmp3 [url|quality]
▷${prefix}⚒⃟►ytmp4 [url|quality]
▷${prefix}⚒⃟►getmusic [yt link]
▷${prefix}⚒⃟►getvideo [yt link]
▷${prefix}⚒⃟►gitclone [repo link]
▷${prefix}⚒⃟►soundcloud [url]
▷${prefix}⚒⃟►zippyshare [url]
▷▂▂▂▂▂▂▂◑「 SEARCH 」	
▷${prefix}⚒⃟►play [query]
▷${prefix}⚒⃟►song [query]
▷${prefix}⚒⃟►yts [query]
▷${prefix}⚒⃟►lyrics [query]
▷${prefix}⚒⃟►google [query]
▷${prefix}⚒⃟►playstore [query]
▷${prefix}⚒⃟►gimage [query]
▷${prefix}⚒⃟►pinterest [query]
▷${prefix}⚒⃟►image [query]
▷${prefix}⚒⃟►film [query]
▷${prefix}⚒⃟►wallpaper [query]
▷${prefix}⚒⃟►searchgc [query]
▷${prefix}⚒⃟►happymod [query]
▷${prefix}⚒⃟►servermc
▷${prefix}⚒⃟►mcpedl [query]
▷${prefix}⚒⃟►tvsearch [query]
▷${prefix}⚒⃟►wikimedia [query]
▷${prefix}⚒⃟►ytsearch [query]
▷${prefix}⚒⃟►ringtone [query]
▷${prefix}⚒⃟►webtoon [query]
▷${prefix}⚒⃟►anime [query]
▷${prefix}⚒⃟►animestory [query]
▷${prefix}⚒⃟►manga [query]
▷${prefix}⚒⃟►wattpad [query]
▷ ${prefix}⚒⃟►mcserver [ip|port]
▷ ${prefix}⚒⃟►drakor [query]
▷▂▂▂▂▂▂▂◑「 CONVERT 」
▷ ${prefix}⚒⃟►toimage [reply stick]
▷ ${prefix}⚒⃟►sticker [reply img|gif]
▷ ${prefix}⚒⃟►take [reply img|gif|stik]
▷ ${prefix}⚒⃟►smeme [reply img]
▷ ${prefix}⚒⃟►emoji [emoji]
▷ ${prefix}⚒⃟►tovideo [reply img]
▷ ${prefix}⚒⃟►togif [reply stick]
▷ ${prefix}⚒⃟►tourl [reply img]
▷ ${prefix}⚒⃟►tovn [reply aud]
▷ ${prefix}⚒⃟►tomp3 [reply vn]
▷ ${prefix}⚒⃟►toaudio [reply vid]
▷ ${prefix}⚒⃟►ebinary [reply txt]
▷ ${prefix}⚒⃟►dbinary [reply txt]
▷ ${prefix}⚒⃟►tinyurl [link]
▷ ${prefix}⚒⃟►styletext [text]
▷${prefix}⚒⃟►volume [reply aud]
▷${prefix}⚒⃟►tempo [reply aud]
▷${prefix}⚒⃟►bass [reply aud]
▷${prefix}⚒⃟►blown [reply aud]
▷${prefix}⚒⃟►deep [reply aud]
▷${prefix}⚒⃟►earrape [reply aud]
▷${prefix}⚒⃟►fast [reply aud]
▷${prefix}⚒⃟►fat [reply aud]
▷${prefix}⚒⃟►nightcore [reply aud]
▷${prefix}⚒⃟►reverse [reply aud]
▷${prefix}⚒⃟►robot [reply aud]
▷${prefix}⚒⃟►slow [reply aud]
▷${prefix}⚒⃟►squirrel [reply aud]
▷▂▂▂▂▂▂▂◑「 IMG EFFECT 」
▷${prefix}⚒⃟►wanted
▷${prefix}⚒⃟►blur
▷${prefix}⚒⃟►framed
▷${prefix}⚒⃟►gayeffect
▷${prefix}⚒⃟►imagesketch
▷${prefix}⚒⃟►invert
▷${prefix}⚒⃟►burn
▷${prefix}⚒⃟►triggeredwebp
▷${prefix}⚒⃟►shit
▷${prefix}⚒⃟►rip
▷${prefix}⚒⃟►jail
▷${prefix}⚒⃟►beautifuleffect
▷${prefix}⚒⃟►deleteeffect
▷${prefix}⚒⃟►pixelate
▷▂▂▂▂▂▂▂◑「 RANDOM IMG 」
▷${prefix}⚒⃟►coffee
▷${prefix}⚒⃟►bts
...
▷${prefix}⚒⃟►wallrandom
▷${prefix}⚒⃟►wallcode
▷${prefix}⚒⃟►animewall [query]
▷${prefix}⚒⃟►animewall2 [query]
▷▂▂▂▂▂▂▂◑「 EMOTE 」
▷${prefix}⚒⃟►instagramemoji
▷${prefix}⚒⃟►facebookemoji
▷${prefix}⚒⃟►iphoneemoji
▷${prefix}⚒⃟►samsungemoji
▷${prefix}⚒⃟►joyemoji
▷${prefix}⚒⃟►skypeemoji
▷${prefix}⚒⃟►twitteremoji
▷${prefix}⚒⃟►whatsappemoji
▷${prefix}⚒⃟►microsoftemoji
▷${prefix}⚒⃟►googleemoji
▷${prefix}⚒⃟►pediaemoji
▷${prefix}⚒⃟►microsoftemoji
▷▂▂▂▂▂▂▂◑「 ANIME 」
▷${prefix}⚒⃟►naruto
...
▷${prefix}⚒⃟►animehappy
▷${prefix}⚒⃟►animedance
▷${prefix}⚒⃟►animecringe
▷${prefix}⚒⃟►animehighfive
▷${prefix}⚒⃟►animehandhold
▷${prefix}⚒⃟►animemegumin
▷${prefix}⚒⃟►smug2
▷${prefix}⚒⃟►couplepp
▷▂▂▂▂▂▂◑「 STICKER 」
▷ ${prefix}⚒⃟►patrick
...
▷${prefix}⚒⃟►gura
▷▂▂▂▂▂▂▂◑「 NSFW 」
▷${prefix}⚒⃟►hentaivideo
▷${prefix}⚒⃟►yuri
▷${prefix}⚒⃟►masturbation
▷${prefix}⚒⃟►thighs
▷${prefix}⚒⃟►pussy
▷${prefix}⚒⃟►panties
▷${prefix}⚒⃟►orgy
...
▷ ${prefix}⚒⃟►rate [text]
▷ ${prefix}⚒⃟►wangy [text]
▷ ${prefix}⚒⃟►beautifulcheck [tag]
▷ ${prefix}⚒⃟►awesomecheck [tag]
▷ ${prefix}⚒⃟►prettycheck [tag]
▷ ${prefix}⚒⃟►lesbiancheck [tag]
▷ ${prefix}⚒⃟►gaycheck [tag]
▷ ${prefix}⚒⃟►cutecheck [tag]
▷ ${prefix}⚒⃟►uglycheck [tag]
▷ ${prefix}⚒⃟►hornycheck [tag]
▷ ${prefix}⚒⃟►charactercheck [tag]
▷ ${prefix}⚒⃟►lovelycheck [tag]
▷ ${prefix}⚒⃟►couple
▷ ${prefix}⚒⃟►mysoulmate
▷ ${prefix}⚒⃟►hot
▷ ${prefix}⚒⃟►sexy
...
▷ ${prefix}⚒⃟►tictactoe
▷ ${prefix}⚒⃟►delttt
▷ ${prefix}⚒⃟►guess [option]
▷ ${prefix}⚒⃟►math [mode]
▷ ${prefix}⚒⃟►suitpvp [tag]
▷▂▂◑「 ANONYMOUS CHAT 」
▷${prefix}⚒⃟►anonymous
▷${prefix}⚒⃟►start
▷${prefix}⚒⃟►next
▷${prefix}⚒⃟►leave
▷▂▂▂▂▂▂◑「 TOOL 」
▷ ${prefix}⚒⃟►translate [text]
▷ ${prefix}⚒⃟►fliptext [text]
▷ ${prefix}⚒⃟►toletter [number]
▷▂▂▂▂▂▂◑「 DATABASE 」
▷ ${prefix}⚒⃟►setcmd
▷ ${prefix}⚒⃟►listcmd
▷ ${prefix}⚒⃟►delcmd
...
▷ ${prefix}⚒⃟►darkjoke
▷ ${prefix}⚒⃟►quotes
▷ ${prefix}⚒⃟►animequotes
▷${prefix}⚒⃟►jalantikus-meme
▷ ${prefix}⚒⃟►merdeka-news 
▷ ${prefix}⚒⃟►kontan-news 
▷ ${prefix}⚒⃟►cnbc-news 
▷ ${prefix}⚒⃟►tribun-news 
▷ ${prefix}⚒⃟►indozone-news 
▷ ${prefix}⚒⃟►kompas-news 
▷ ${prefix}⚒⃟►detik-news 
▷ ${prefix}⚒⃟►daily-news 
▷ ${prefix}⚒⃟►inews-news 
▷ ${prefix}⚒⃟►okezone-news 
▷ ${prefix}⚒⃟►sindo-news 
▷ ${prefix}⚒⃟►tempo-news 
▷ ${prefix}⚒⃟►antara-news 
▷ ${prefix}⚒⃟►cnn-news 
▷ ${prefix}⚒⃟►fajar-news 
▷${prefix}⚒⃟►cinemaschedule
▷${prefix}⚒⃟►wiki
▷${prefix}⚒⃟►covidindo
▷${prefix}⚒⃟►earthquake
▷${prefix}⚒⃟►tvschedule
...
▷${prefix}⚒⃟►artinama 
▷${prefix}⚒⃟►ramaljodoh 
▷${prefix}⚒⃟►ramaljodohbali 
▷${prefix}⚒⃟►suamiistri 
▷${prefix}⚒⃟►ramalcinta 
▷${prefix}⚒⃟►cocoknama 
▷${prefix}⚒⃟►pasangan 
▷${prefix}⚒⃟►jadiannikah 
▷${prefix}⚒⃟►sifatusaha 
▷${prefix}⚒⃟►rezeki 
▷${prefix}⚒⃟►pekerjaan 
▷${prefix}⚒⃟►nasib 
...
▷${prefix}⚒⃟►nagahari
▷${prefix}⚒⃟►arahrezeki
▷${prefix}⚒⃟►peruntungan 
▷${prefix}⚒⃟►weton 
▷${prefix}⚒⃟►karakter
▷${prefix}⚒⃟►keberuntungan
▷${prefix}⚒⃟►memancing
▷${prefix}⚒⃟►masasubur
▷${prefix}⚒⃟►zodiak
▷${prefix}⚒⃟►shio
...
▷${prefix}⚒⃟►hidetag [text]
▷${prefix}⚒⃟►tagall [text]
▷${prefix}⚒⃟►autosticker [on/off]
▷${prefix}⚒⃟►autostickerpc [on/off]
▷${prefix}⚒⃟►leveling [on/off]
▷${prefix}⚒⃟►antilinkgc [on/off]
▷${prefix}⚒⃟►antilinktg [on/off]
▷${prefix}⚒⃟►antilinktt [on/off]
▷${prefix}⚒⃟►antilinkytch [on/off]
